    ...
    <div className="text-center  mt-5 py-10 lg:px-10 flex-col">
        <Container >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white gap-5">
              ...
              <div className="before:content-[''] before:absolute before:h-full before:left-0 before:z-[1] before:w-full before:bg-black/50 before:overflow-hidden overflow-hidden object-cover h-52  relative object-bottom md:col-span-2 rounded-xl">
              ...
              <div className=" before:content-[''] before:absolute before:h-full before:left-0 before:z-[1] before:w-full before:bg-black/50 before:overflow-hidden overflow-hidden object-cover h-52  relative object-bottom rounded-xl">
              ...
              <div className=" before:content-[''] before:absolute before:h-full before:left-0 before:z-[1] before:w-full before:bg-black/50 before:overflow-hidden md:col-span-2 overflow-hidden object-cover h-52  relative object-bottom rounded-xl">
